  ...
  const image = [
    {
      ...
      title: "인상, 해돋이",
      painter: "클로드 모네",
      discription: `모네가 르아브르 항구의 아침 풍경을 그린 유화이다. ‘인상주의’라는 용어의 유래로 알려져 있다. 모네의 ‘인상, 해돋이’는 미술사에서 특별히 중요한 의미를 갖는다. 앞에서 언급했듯이 ‘인상, 해돋이’는 19세기 후반을 퐁미한 인상파의 서막을 알리는 그림으로, 인상파란 유파의 이름도 이것에서 유래됐다.
    ...
    },
    {
      ...
      title: "지베르니의 예술가 정원",
      painter: "클로드 모네",
      discription: "지베르니의 예술가 정원 (프랑스어: Le Jardin de l'artiste à Giverny)은 1900년에 그린 클로드 모네가 현재 파리 오르셰 미술관에서 그린 유화입니다. 이것은 지베르니 정원의 예술가가 생애 마지막 30년 동안 수행한 많은 작품 중 하나입니다. 이 그림은 화면을 가로질러 대각선으로 설정된 보라색과 분홍색의 다양한 색조의 붓꽃 행을 보여줍니다. 꽃은 나무 아래에 있어 색상의 색조를 변경하여 얼룩덜룩한 빛을 허용합니다. 나무 너머로 모네의 집이 살짝 보입니다.",
    },
    {
      src: "https://aim-front.s3.ap-northeast-2.amazonaws.com/basic4.jpeg",
      title: "아르장퇴유의 연못",
      painter: "클로드 모네",
      discription: "모네는 밝고 강렬한 색채와 거친 붓놀림으로 물 위에 나타나는 빛의 진동과 반사광을 표현했는데, 특히 아르장퇴유의 요트 경기장 풍경을 그린 작품에서 이런 특징이 분명하게 나타납니다. 이처럼 화폭에 담긴 여가의 풍경을 주제로 한 이야기는 모파상의 단편 소설집에서도 언급됩니다. 이 그림의 좌측에는 아르장퇴유의 산책로가 눈에 띕니다. 햇빛이 나무 사이로 새어 들며 지상에 빛의 흔적을 남겼으며, 후경에 있는 다리의 양쪽 끝에는 통행료 징수소가 보입니다. 우측 전경에는 목욕용 폐선과 공동 세탁장이 눈에 띕니다. 하지만 모네가 역점을 둔 것은 바로 구름이 스쳐 지나가는 푸른 하늘이었습니다. \n 이 작품은 인상주의 화가들의 친구이자 유명한 화상인 뒤랑 뤼엘이 소유하고 있다가 1893년 3월 16일에 이작 드 카몽도 백작에게 팔았습니다. 일찍부터 마네와 인상주의 화가들의 몇몇 걸작품을 수집한 드 카몽도 백작은 이 작품을 프랑스 정부에 유증했습니다.",
    },
    {
      src: "https://aim-front.s3.ap-northeast-2.amazonaws.com/basic5.jpeg",
      title: "고디베르 부인의 초상",
      painter: "클로드 모네",
      discription: "모네의 일반적인 작품 계열과 작품에서 벗어난 특이한 그림입니다. 식사를 하고 있는 사람들보다 램프와 램프빛의 효과가 이 그림의 모티브이며, 일정한 장소에 일정하게 주어진 빛, 그것도 대자연의 빛이 아닌 인공(人工)의 빛을 집요하게 묘사하려는 모네의 의식과 또 하나의 시각을 읽을 수 있습니다. 하얀 식탁 위의 검소한 차림, 희미한 그림자와 다갈색의 벽면 등이 서로 조화되어 차분하고 온화한 뉘앙스를 표출시켰고, 또한 화가의 생활 수준과 청교도적인 가풍을 간접적으로 시사했습니다. 제 1회 인상파전이 열리기 4년 전의 그림이라는데에 주목해야 합니다",
    },
